...
function addreflinkpreview(e) {
	...
	if (e.pageX) {
		...
		previewdiv.style.left = (e.clientX + 20);
	}
	if (e.pageY) {
		previewdiv.style.top = '' + (e.pageY + 50) + 'px';
	} else {
		previewdiv.style.top = (e.clientY + 50);
	}
	...
	new Ajax.Request(ku_boardspath + '/read.php?b=' + ainfo[1] + '&t=' + ainfo[2] + '&p=' + ainfo[3] + '&single',
	{
		...
		onFailure: function(){
			var aj_fail = "ajax request failed";
			newelement.innerHTML = aj_fail;
		}
	});
}
